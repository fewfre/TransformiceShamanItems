	...
	public class ShopInfoBar extends MovieClip
	{
		...
		public function ShopInfoBar(pData:Object=null) {
			...
			*********************/
			...
			/*if(pData.showRefreshButton == null || pData.showRefreshButton) {
				refreshButton = addChild(new SpriteButton({ x:tX - 24, y:0, width:tSize, height:tSize, obj_scale:0.5, obj:new $Refresh() }));
				refreshLockButton = addChild(new PushButton({ x:tX - 24, y:26, width:tSize, height:tSize, obj_scale:0.8, obj:new $Lock() }));
				tX -= tSize + 2;
			}*/
